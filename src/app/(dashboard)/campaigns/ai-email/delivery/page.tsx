...
export default function CampaignJobsPage() {
  ...
  const getProviderLabel = (job: CampaignJob) => {
    ...
    switch (provider) {
      case 'brevo':
        return <Badge variant="outline" className="ml-2 text-xs">Brevo</Badge>;
      case 'sender':
        return <Badge variant="outline" className="ml-2 text-xs">Sender.net</Badge>;
      case 'smtp':
        return <Badge variant="outline" className="ml-2 text-xs">SMTP</Badge>;
      default:
        return null;
    }
  };
                    ...
                    <TableRow key={job.id}>
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          {job.jobType === 'email' && getProviderLabel(job)}
                        </div>
                      </TableCell>
